...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        self.epsilon = self.eps_end if t > self.nsteps else t / self.nsteps * (self.eps_end - self.eps_begin) + self.eps_begin
...
class LinearExploration(LinearSchedule):
    ...
    def get_action(self, best_action):
        ...
        return self.env.action_space.sample() if np.random.random() < self.epsilon else best_action
        ##############################################################
        ######################## END YOUR CODE #######################
